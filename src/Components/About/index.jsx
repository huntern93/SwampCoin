      ...
      <section id="about" className={styles.about}>
        <Container className="mid-container">
          <div className={styles.aboutInner}>
            <img src={AboutImg1} className={styles.aboutImg1} />
            <Row className="g-0">
              <Col md={4}></Col>
              <Col md={6}>
                <h2 className="fw-bold">ABOUT $SWAMP</h2>
                ...
                <a className={`size-24 ${styles.buyNow} mb-4`} href="#">
                  ...
                  <svg width="40" height="39" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18.375 30.875L28.125 19.5L18.375 8.125" stroke="black" stroke-width="2.4375" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M11.875 30.875L21.625 19.5L11.875 8.125" stroke="black" stroke-width="2.4375" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                </a>
                <JoinCommunity size="small" />
              </Col>
            </Row>
            <img src={AboutImg2} className={styles.aboutImg2} />
          </div>
        </Container>
      </section>
    </>
