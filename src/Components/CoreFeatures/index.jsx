      ...
      <section id="features" className="">
        <Container className="big-container">
          ...
          <div className={styles.coreFeatureInner}>
            ...
            <p className="size-30 fw-bold mb-0">Presale price increases across 100 levels from $0.0002 to $0.0060 – don't miss the early entry!</p>
          </div>
        </Container>
      </section>
    </>
